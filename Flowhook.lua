...
local i,j;local k,l=618,548;local m,n=300,250;local o;local p=1;local q,r=1,0;local s,t=0,0;local u=20;local v=false;local w=gui.Checkbox(gui.Reference("SETTINGS","Miscellaneous"),"lynxclient_show_flowhooks_menu","[Lynx] Show FlowHooks PlayerList",true)
